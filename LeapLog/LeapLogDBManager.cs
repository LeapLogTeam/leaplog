...
namespace LeapLog
{
	class LeapLogDBManager
	{
		...
		public LeapLogDBManager()
		{
			...
			connection = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\USERS\ENGEL\DOWNLOADS\NEW FOLDER\UPDATED 4-17\LEAPLOG\LEAPLOG\TABLES\DATABASE1.MDF;Integrated Security=True");
		}
